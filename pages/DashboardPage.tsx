...
import { 
  ...
  Key, Calendar, Plus, X, LogOut, User, ChevronDown, PlusCircle
} from 'lucide-react';
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
                ...
                >
                    ...
                    <span className="text-[10px] text-indigo-500 font-medium -mt-1">คุณยายดวง Wallet</span>
                </button>
                            ...
                            <div className="max-h-48 overflow-y-auto custom-scrollbar">
                                {wallets.map(w => (
                                    <button
                                        ...
                                        className={`w-full text-left flex items-center justify-between px-3 py-2.5 rounded-lg text-sm mb-1 ${
                             ...
                             <button 
                                ...
                                className="w-full text-left flex items-center gap-2 px-3 py-2.5 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-sm text-indigo-600 font-medium border-t border-slate-100 dark:border-slate-800 mt-1"
                            >
